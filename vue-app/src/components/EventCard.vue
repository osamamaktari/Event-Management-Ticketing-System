...
<img v-if="imageUrl" :src="imageUrl" :alt="event.title" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
    ...
    <div class="p-4">
      ...
      <div class="mt-4 flex items-center justify-between text-sm">
        <div class="text-gray-700 dark:text-gray-400 flex items-center justify-center gap-2">
